...
@section('content')
<div class="col-lg-8">
    {{Form::model($couponsDetails,array('files'=>true))}}
        ...
        <div class="form-group">
           ...
           {{Form::text('coupon_name',null,array('class'=>'form-control','placeholder'=>'Enter Coupon'))}}
        </div>

        <div class="form-group">
            <label class="control-label" >Coupon Code <span class="red-star">★</span></label>
           {{Form::text('coupon_code',null,array('class'=>'form-control','placeholder'=>'Enter Coupon Code'))}}
        </div>
        ...
        <div class="form-group">
           ...
           {{Form::text('tags',null,array('class'=>'form-control','placeholder'=>'ADD TAGS FOR SEARCHING','data-role'=>'tagsinput'))}}
        </div>
