...
<script type="text/javascript">
  $(function(){
    $( "#loginForm" ).submit(function( event ) {
      ...
      $('#loginMessage').empty().append('<span class="glyphicon glyphicon-refresh glyphicon-refresh-animate"></span> Loading Please Wait...');
      ...
      posting.done(function( data ) {
        ...
        if(data.success) {
          if(data.userType=='admin')
          {
            ...
            window.location.replace("{{URL::to('/')}}/get-started");
          }         
        } // fail           
      }); //done
    });
